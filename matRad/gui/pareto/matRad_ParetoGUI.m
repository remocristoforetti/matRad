...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    properties (Access = private)
        ...
        ParetoProjectionVisualizationWidget;
    end
    ...
    methods
        ...
        pButtonWidget = uipanel(...
            ...
            'Clipping','off',...
            'Position',[0.35 0.51 0.15 0.1],...
            'FontName',matRad_cfg.gui.fontName,...
            'FontSize',matRad_cfg.gui.fontSize,...
            'FontWeight',matRad_cfg.gui.fontWeight);

         pProjectionVisualizationWidget = uipanel(...
            'Parent',this.guiHandle,...  
            'Units','normalized',...
            'BackgroundColor',matRad_cfg.gui.backgroundColor,...
            'Tag','Pareto Surface Visualization',...
            'Clipping','off',...
            'Position',[0.51 0.005 0.45 0.49],...
            'FontName',matRad_cfg.gui.fontName,...
            'FontSize',matRad_cfg.gui.fontSize,...
            'FontWeight',matRad_cfg.gui.fontWeight);
        ...
        this.ParetoProjectionVisualizationWidget = matRad_ParetoProjectionVisualizationWidget(pProjectionVisualizationWidget);
        this.ParetoSliderWidget = matRad_ParetoSliderWidget(pSliderWidget,this.ParetoSliceWidget,this.ParetoProjectionVisualizationWidget);
