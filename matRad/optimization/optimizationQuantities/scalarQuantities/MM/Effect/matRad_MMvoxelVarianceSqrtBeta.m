classdef matRad_MMvoxelVarianceSqrtBeta < matRad_MMscalarQuantity
    ...
    properties (Constant)
        ...
        requiredSubquantities = {'protonsVoxelVarianceSqrtBetaDose', 'photonsVoxelVarianceSqrtBetaDose'};
        protonSubquantity = 'protonsVoxelVarianceSqrtBetaDose';
        photonSubquantity = 'photonsVoxelVarianceSqrtBetaDose';
    end
