classdef matRad_TotalVarianceQReduced < matRad_ScalarQuantity

    properties (Constant)
        quantityName = 'vTotReduced';
        requiredSubquantities = {'dOmegaReduced'};

    end

    methods
        function this = matRad_TotalVarianceQReduced(cst)
            if nargin>0
                supArg = {cst};
            else
                supArg = {};
