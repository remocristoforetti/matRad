classdef matRad_MaxMeanVariance < OmegaConstraints.matRad_VarianceConstraint
    ...
    methods
        function this = matRad_MaxMeanVariance(maxVaraince)
        ...
        function cVarianceJacob  = computeVarianceConstraintJacobian(~,dOmega, nVoxels)
            if ~isscalar(dOmega)
                % For older code compatibility
                %cVarianceJacob = (2/nVoxels) * dOmega;
                cVarianceJacob = (1/nVoxels) * dOmega;
            else
                %cVarianceJacob = (2/nVoxels);
                cVarianceJacob = (1/nVoxels);
