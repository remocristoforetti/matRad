#ifndef TsDoseEventsCounter_hh
#define TsDoseEventsCounter_hh
...
class TsDoseEventsCounter : public TsVBinnedScorer
{
public:
	TsDoseEventsCounter(TsParameterManager* pM, TsMaterialManager* mM, TsGeometryManager* gM, TsScoringManager* scM, TsExtensionManager* eM,
			G4String scorerName, G4String quantity, G4String outFileName, G4bool isSubScorer);

	virtual ~TsDoseEventsCounter();
	...
	G4double getDose(G4Step* aStep, G4double eDep);
