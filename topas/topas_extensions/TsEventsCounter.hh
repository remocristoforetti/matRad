#ifndef TsEventsCounter_hh
#define TsEventsCounter_hh

#include "TsVBinnedScorer.hh"
#include "G4VProcess.hh"

class TsEventsCounter : public TsVBinnedScorer
{
public:
	TsEventsCounter(TsParameterManager* pM, TsMaterialManager* mM, TsGeometryManager* gM, TsScoringManager* scM, TsExtensionManager* eM,
                G4String scorerName, G4String quantity, G4String outFileName, G4bool isSubScorer);

	virtual ~TsEventsCounter();
