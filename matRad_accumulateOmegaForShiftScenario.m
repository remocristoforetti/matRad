function dij = matRad_accumulateOmegaForShiftScenario(dij,pln,cst,shiftScen)
            ...
            for ctIdx=1:pln.multScen.numOfCtScen
                ...
                for rangeShiftScen = 1:pln.multScen.totNumRangeScen
                    if pln.multScen.scenMask(ctIdx,shiftScen,rangeShiftScen)
                        ...
                        scenIdx = find(ismember(pln.multScen.linearMask,[ctIdx,shiftScen,rangeShiftScen], 'rows'));
                        if ~isempty(scenIdx)
