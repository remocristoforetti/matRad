function dij = matRad_calcPhotonDoseAccumulate(ct,stf,pln,cst,calcDoseDirect)
    ...
    switch pln.propDoseCalc.probabilisticQuantitiesMode
        case 'phase'
            ...
            for ctIdx=1:pln.multScen.numOfCtScen
                for v = voiIx
                    ...
                    dijCurr = dij.physicalDoseExp{ctIdx}(structVoxels,:);
                    dij.physicalDoseOmega{v,ctIdx} = dij.physicalDoseOmega{v, ctIdx} - (dijCurr' * dijCurr);
                end
            end
        ...
        case 'all'
            ...
            for v = voiIx
                ...
                dijCurr = dij.physicalDoseExp{1}(structVoxels,:);
                dij.physicalDoseOmega{v} = dij.physicalDoseOmega{v} - (dijCurr' * dijCurr);
            end
            matRad_cfg.dispInfo('...done\n');
    end
end
