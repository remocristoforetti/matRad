classdef matRad_OptimizationProblemVisualization < handle
    ...
    methods
        function obj = matRad_OptimizationProblemVisualization(backProjection)
        ...
        function instantiateVisualization(this, cst)
            if isempty(this.graphicOutput)
                this.graphicOutput = matRad_optimizationProblemVisualizer(cst);
            end
        end
